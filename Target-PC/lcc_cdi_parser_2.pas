...
begin
  ...
  ButtonContainer.Align := {$IFDEF FPC}alClient{$ELSE}TAlignLayout.Bottom{$ENDIF};
  ...
  StatusLabel.{$IFDEF FPC}Caption{$ELSE}Text{$ENDIF} := 'Status: Building';

  ButtonReadWriteStop := TLccSpeedButton.Create(ButtonContainer);
  ButtonReadWriteStop.{$IFDEF FPC}Caption{$ELSE}Text{$ENDIF} := 'Stop Page';
  ButtonReadWriteStop.Align := {$IFDEF FPC}alClient{$ELSE}TAlignLayout.Bottom{$ENDIF};
 ...
 // ButtonReadPage.OnClick := @DoButtonWritePageClick;
  ...
  ButtonReadPage.{$IFDEF FPC}Caption{$ELSE}Text{$ENDIF} := 'Read Page';
  ButtonReadPage.Align := {$IFDEF FPC}alClient{$ELSE}TAlignLayout.Bottom{$ENDIF};
 // ButtonReadPage.Height := 44;
 // ButtonReadPage.OnClick := @DoButtonWritePageClick;
  ButtonReadPage.Parent := ButtonContainer;

  ButtonWritePage := TLccSpeedButton.Create(ButtonContainer);
  ButtonWritePage.{$IFDEF FPC}Caption{$ELSE}Text{$ENDIF} := 'Write Page';
  ButtonWritePage.Align := {$IFDEF FPC}alClient{$ELSE}TAlignLayout.Bottom{$ENDIF};
